        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {methodology.map(({ step, title, description }) => (
              <div key={step} className="group relative bg-[#0D0D0D] border border-white/10 rounded-xl p-6 card-hover">
                <div className="font-syne font-extrabold text-5xl text-accent/20 mb-4 leading-none select-none group-hover:text-accent/30 transition-colors">
                  {step}
                </div>
                <h3 className="font-syne font-bold text-white text-base mb-3 group-hover:text-accent transition-colors">{title}</h3>
                <p className="text-slate-400 text-sm leading-relaxed">{description}</p>
              </div>
            ))}
          </div>
          <div className="mt-10 bg-[#0D0D0D] border border-white/10 rounded-xl p-6">
            <h3 className="font-syne font-semibold text-white text-sm mb-4">What's included in every engagement</h3>
