  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-primary/95 backdrop-blur-md border-b border-accent/20 shadow-lg shadow-black/30'
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:block">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 bg-accent text-primary font-syne font-semibold text-sm px-5 py-2.5 rounded hover:bg-accent/90 transition-all duration-200 hover:shadow-lg hover:shadow-accent/20"
            >
              Get Free Assessment
            </Link>
          </div>
          ...
          <motion.button
            ...
            className="lg:hidden text-slate-300 hover:text-accent transition-colors p-2 rounded"
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="bg-primary/98 border-t border-accent/10 px-4 py-4 space-y-1">
              {navLinks.map((link) => (
              ...
              <motion.div variants={linkVariants} className="pt-3">
                <Link
                  to="/contact"
                  className="block w-full text-center bg-accent text-primary font-syne font-semibold text-sm px-5 py-3 rounded hover:bg-accent/90 transition-colors"
                >
                  Get Free Assessment
                </Link>
              </motion.div>
